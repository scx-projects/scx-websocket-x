...
/// @author scx567888
/// @version 0.0.1
public final class WebSocketUpgradeRequestFactory implements Http1UpgradeRequestFactory<ScxServerWebSocketHandshakeRequest> {
    ...
    @Override
    public ScxServerWebSocketHandshakeRequest createUpgradeRequest(Http1RequestLine requestLine, Http1Headers headers, Long bodyLength, ByteInput bodyByteInput, Http1ServerConnection connection) {
