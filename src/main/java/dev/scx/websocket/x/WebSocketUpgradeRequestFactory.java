...
/// WebSocketUpgradeRequestFactory
///
/// @author scx567888
public final class WebSocketUpgradeRequestFactory implements Http1UpgradeRequestFactory<ScxWebSocketServerHandshakeRequest> {
    ...
    @Override
    public ScxWebSocketServerHandshakeRequest createUpgradeRequest(Http1RequestLine requestLine, Http1Headers headers, Long bodyLength, ByteInput bodyByteInput, Http1ServerConnection connection) {
        return new Http1WebSocketServerHandshakeRequest(requestLine, headers, bodyLength, bodyByteInput, connection, webSocketOptions);
    }
