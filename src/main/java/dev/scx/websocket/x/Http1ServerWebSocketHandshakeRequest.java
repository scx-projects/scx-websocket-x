...
/// @author scx567888
/// @version 0.0.1
public final class Http1ServerWebSocketHandshakeRequest implements ScxServerWebSocketHandshakeRequest {
    ...
    public Http1ServerWebSocketHandshakeRequest(Http1RequestLine requestLine, Http1Headers headers, Long bodyLength, ByteInput bodyByteInput, Http1ServerConnection connection, WebSocketOptions webSocketOptions) {
        ...
        this.response = new Http1ServerWebSocketHandshakeResponse(this, _request.response(), webSocketOptions);
    }
