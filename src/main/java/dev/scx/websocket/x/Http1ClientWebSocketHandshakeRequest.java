...
/// Http1ClientWebSocketHandshakeRequest
///
/// @author scx567888
/// @version 0.0.1
public final class Http1ClientWebSocketHandshakeRequest implements ScxClientWebSocketHandshakeRequest {
    ...
    public ScxClientWebSocketHandshakeResponse handshake() throws IllegalSenderStateException, ScxHttpSendException, ScxWrappedException, ScxHttpReceiveException {
        ...
        return new Http1ClientWebSocketHandshakeResponse(clientResponse, secWebSocketKey, webSocketOptions);
    }
